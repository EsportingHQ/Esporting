...
import { Shield, Activity, Users, Settings, LogOut, Layout } from 'lucide-react';
...
const organiserNav: NavItem[] = [
  ...
  { label: 'New Competition', href: '/organiser/competitions/new', icon: PlusIcon },
];
    ...
    <div className="min-h-screen bg-bg-void text-text-primary flex flex-col font-body antialiased">
      ...
      <header className="bg-bg-void border-b border-border-line px-6 py-4 flex items-center justify-between shrink-0">
        <div className="flex items-center gap-6">
          <Link href="/" className="font-display font-black text-xl tracking-widest text-text-primary uppercase hover:text-accent-readout transition-colors">
            ESPORTING
          </Link>
