    ...
    try {
      const { data, error: insertError } = await supabase
        ...
        .insert({
          ...
          team_home_id: matchFormat === "head_to_head" ? homeTeamId : null,
          team_away_id: matchFormat === "head_to_head" ? awayTeamId : null,
          best_of: bestOf,
          ...
          <div>
            ...
            >
              {stages
                .filter(
                  (s) =>
                    s.game_title_id === null || s.game_title_id === gameTitleId,
                )
                .map((s) => (
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => {
                ...
                const newGame = gameTitles.find((g) => g.id === newGameId);
        ...
        <div style={{ marginBottom: 10 }}>
          ...
          <div style={{ display: "flex", gap: 8 }}>
            <button
              ...
              style={toggleButtonStyle(matchFormat === "head_to_head")}
            >
              Head to Head
            </button>
            {!isFootballGame && (
              <button
                ...
                style={toggleButtonStyle(matchFormat === "battle_royale")}
              >
                Battle Royale
              </button>
            )}
