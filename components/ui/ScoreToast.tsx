		...
		>
			<div className="flex items-start gap-2.5 flex-1 min-w-0">
				...
				>
					...
					<div className="flex items-center gap-2 font-display font-bold text-sm text-text-primary group-hover:text-accent-readout transition-colors mt-0.5">
						{toast.homeLogoUrl ? (
							<Image
								src={toast.homeLogoUrl}
								alt=""
								width={20}
								height={20}
						...
						<span className="truncate">{toast.homeTeam}</span>
						<span className="text-text-muted">vs</span>
						{toast.awayLogoUrl ? (
							<Image
								src={toast.awayLogoUrl}
								alt=""
								width={20}
								height={20}
								className="h-5 w-5 rounded object-cover"
						...
						<span className="truncate">{toast.awayTeam}</span>
					</div>
